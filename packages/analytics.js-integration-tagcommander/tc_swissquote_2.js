 ...
 * Generated: 2017-10-16 15:36:47 Europe/Paris
 * ---
 * Version	: 2.00
 * IDTC 	: 2
 * IDS		: 3551
 */
/*!compressed by YUI*/ if (typeof tC == "undefined") {
    if (
    ...
    tC.containersLaunched[3551][2] = { v: "2.00", t: [] };
    tC.extend({
      domReady: false,
      isDOMReady: function() {
    ...
    tC.extend({
      hitCounter: function() {
        if (Math.floor(Math.random() * parseInt(1000)) == 0) {
          tC.pixelTrack.add(
            "//manager.tagcommander.com/utils/hit.php?id=2&site=3551&version=2.00&frequency=1000&position=" +
    ...
    tC3551_2 = tC; /* RETRO COMPATIBILITY FUNCTIONS */
    ...
    if (tC.getCookie("tc_mode_test") == 1) {
      ...
      tC.launchTag("2", "TagCommander - Recette", "26", "3551", "2");
      tC.setCookie("tCdebugLib", 1, 30);
      tC.log("TagCommander - Loaded Marketing container");
      tC.log(tc_vars);
      tC.launchTag("4", "Facebook - Pixel", "1264", "3551", "2");
      ...
      fbq("init", "336865183350857");
      fbq("track", "PageView");
      fbq("track", "TagCo_Test");
      tC.launchTag("5", "Universal Analytics (builder)", "1731", "3551", "2");
    ...
    function tc_events_2(tc_elt, tc_id_event, tc_array_events) {
      ...
      if (tc_array_events["id"] == "click") {
        tC.launchTag("eclick", "Click", "-1", "3551", "2");
        tC.setCookie("tCdebugLib", 1, 30);
        tC.log("TagCommander - Event fired");
